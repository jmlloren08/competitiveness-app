...
export default function IndicatorRankingNRI() {
    ...
    const fetchChartData = () => {
        axios.get('/get-indicator-ranking-nri')
            .then(response => {
                ...
                <table className='min-w-full bg-white border text-sm sm:table hidden'>
                    ...
                    <tbody>
                        {chartData.series.map((seriesItem, seriesIndex) => {
                            const isMainCategory = ['Technology', 'People', 'Governance', 'Impact'].includes(seriesItem.name);
