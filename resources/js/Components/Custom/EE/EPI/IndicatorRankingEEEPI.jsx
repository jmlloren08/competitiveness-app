...
export default function IndicatorRankingEEEPI() {
    ...
    const fetchChartData = () => {
        axios.get('/get-ee-epi-indicator-ranking')
            .then(response => {
                ...
                <table className='min-w-full bg-white border text-sm sm:table hidden'>
                    ...
                    <tbody>
                        {chartData.series.map((seriesItem, seriesIndex) => {
                            const isMainCategory = ['Environmental Health', 'Ecosystem Vitality', 'Climate Change'].includes(seriesItem.name);
