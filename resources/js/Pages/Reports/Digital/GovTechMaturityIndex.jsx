                        ...
                        <div className='relative overflow-hidden'>
                            ...
                            <div className='absolute inset-0 flex items-center justify-center'>
                                <div className='text-center text-white'>
                                    <h1 className='text-2xl sm:text-6xl mx-12 sm:m-4 font-bold'>GOVTECH MATURITY INDEX</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <section>
                        <div className='max-w-6xl mx-auto shadow-lg mb-12 p-5 rounded'>
                            ...
                            <div className='mt-12 mb-12'>
                                ...
                                <p className='p-3'>The GovTech Maturity Index (GTMI) Data Dashboard was launched in November 2022 to provide users with a means to visually review and compare data on four GovTech focus areas by year, economy, region, GTMI components, among others. The dashboard is structured in six pages, each one offering multiple filters and views to allow the user to gain different insights. In addition to the GTMI data, the users can explore the details of World Bank investments in four GovTech focus areas through the “Projects” page providing access to the 2022 GovTech Projects Database. It includes data on 1449 digital governance/GovTech projects funded in 147 countries since 1995. This quick reference guide introduces the six pages of the dashboard, together with an explanation of various dashboard actions to assist the users in navigating the platform.</p>
                            </div>
