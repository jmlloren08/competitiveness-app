...
const HNGHSI = React.lazy(() => import('@/Components/Custom/HN/GHSI/HNGHSI'));
const IndicatorRankingHNGHSI = React.lazy(() => import('@/Components/Custom/HN/GHSI/IndicatorRankingHNGHSI'));

export default function GlobalHealthSecurityIndex() {
    ...
    useEffect(() => {
        axios.get('/get-hn-ghsi-philippine-ranking')
            .then(response => {
    ...
    return loading ? (
        ...
        <>
            <Head title="Competitiveness Dashboard - Reports/Health & Nutrition/Global Health Security Index" />
                        ...
                        <div className='relative overflow-hidden'>
                            ...
                            <div className='absolute inset-0 flex items-center justify-center'>
                                <div className='text-center text-white'>
                                    <h1 className='text-2xl sm:text-6xl mx-12 sm:m-4 font-bold'>GLOBAL HEALTH SECURITY INDEX</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <section>
                        <div className='max-w-6xl mx-auto shadow-lg mb-12 p-5 rounded'>
                            ...
                            <div className='mt-12 mb-12'>
                                ...
                                <p className='p-3'>The 2021 Global Health Security (GHS) Index finds that despite significant steps taken by countries to respond to the COVID-19 pandemic, all countries remain dangerously unprepared to meet future epidemic and pandemic threats. With data captured during a period when countries wrestled with COVID-19, researchers used a revised framework and updated data collection to glean hard truths about pandemic preparedness while assessing and benchmarking health security capacities across 195 countries. As a measure of health security, the Index assigns the highest scores to countries with the most extensive capacities to prevent and respond to epidemics and pandemics. The result highlights that although the GHS Index can identify preparedness resources and capacities available in a country, it cannot predict whether or how well a country will use them in a crisis.</p>
                            </div>
                            ...
                            <div className='mt-12 mb-12'>
                                ...
                                <p className='p-2 font-bold text-lg underline'>
                                    <a href="https://dhsprogram.com/pubs/pdf/FR381/FR381.pdf" className='text-blue-500 transition ease-in-out hover:text-blue-700 hover:text-xl'>
                                        2022 Philippine National Demographic and Health Survey (NDHS), February 2023.
                                    </a>
                                </p>
                            </div>

                            <div className='mt-12 mb-12'>
                                <h2 className='text-white text-2xl text-center font-bold mb-6 bg-sky-900 p-5 rounded'>DOWNLOAD THE GLOBAL HEALTH SECURITY INDEX</h2>
                                <p className='p-2 font-bold text-lg underline'>
                                ...
                                <p className='p-2 font-bold text-lg underline'>
                                    <a href="https://ghsindex.org/wp-content/uploads/2021/11/2019-Global-Health-Security-Index.pdf" className='text-blue-500 transition ease-in-out hover:text-blue-700 hover:text-xl'>
