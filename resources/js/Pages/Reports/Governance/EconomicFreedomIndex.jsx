...
export default function EconomicFreedomIndex() {
    ...
    return (
        <>
            <Head title="Competitiveness Dashboard - Reports/Governance/Economic Freedom Index" />
                        ...
                        <div className='relative overflow-hidden'>
                            ...
                            <div className='absolute inset-0 flex items-center justify-center'>
                                <div className='text-center text-white'>
                                    <h1 className='text-2xl sm:text-6xl mx-12 sm:m-4 font-bold'>ECONOMIC FREEDOM INDEX</h1>
                                </div>
                            </div>
                        </div>
                    </div>
