...
export default function CorruptionPerceptionsIndex() {
    ...
    useEffect(() => {
        axios.get('/get-governance-cpi-philippine-ranking')
            .then(response => {
    ...
    return (
        <>
            <Head title="Competitiveness Dashboard - Reports/Governance/Corruption Perceptions Index" />
                        ...
                        <div className='relative overflow-hidden'>
                            ...
                            <div className='absolute inset-0 flex items-center justify-center'>
                                <div className='text-center text-white'>
                                    <h1 className='text-2xl sm:text-6xl mx-12 sm:m-4 font-bold'>CORRUPTION PERCEPTIONS INDEX</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <main className='bg-white mx-4 sm:mx-6 lg:mx-32 px-4 sm:px-6 lg:px-8'>
                    ...
                    <section>
                        <div className='max-w-6xl mx-auto shadow-lg mb-12 p-5 rounded'>
                            <p className='text-blue-900 text-xl'><span className='font-bold'>CATEGORY:</span> GOVERNANCE</p>
                            ...
                            <div className='mt-12 mb-12'>
                                ...
                                <p className='p-3'>The corruption Perception Index (CPI) is an annual assessment by Transparency International that ranks countries based on perceived levels of public sector corruption . It gathers data from multiple sources to measure corruption within the public sector, offering a score that reflects how corrupt a country is perceived to be by experts and business leaders. The index aims to raise awareness of corruption and encourage governments to take action to combat it, promoting transparency and accountability in public institutions.</p>
                            </div>
