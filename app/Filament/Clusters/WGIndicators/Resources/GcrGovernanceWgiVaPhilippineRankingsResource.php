...
use App\Filament\Clusters\WGIndicators\Resources\GcrGovernanceWgiVaPhilippineRankingsResource\Pages;
use App\Filament\Clusters\WGIndicators\Resources\GcrGovernanceWgiVaPhilippineRankingsResource\RelationManagers;
...
class GcrGovernanceWgiVaPhilippineRankingsResource extends Resource
{
    protected static ?string $model = GcrGovernanceWgiVaPhilippineRankings::class;
    protected static ?string $modelLabel = 'WGI - Voice and Accountability Philippine Rankings';
    protected static ?string $navigationLabel = 'WGI-VA Philippine Rankings';
    protected static ?string $navigationIcon = '/backend/assets/images/icon-va.png';
    ...
    private static function validateUniqueYear(): callable
    {
        return function ($get, $record) {
            return function ($attribute, $value, $fail) use ($record) {
                $exists = GcrGovernanceWgiVaPhilippineRankings::where('year', $value)
    ...
    {
        return [
            'index' => Pages\ListGcrGovernanceWgiVaPhilippineRankings::route('/'),
        ];
    }
}
