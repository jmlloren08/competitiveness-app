...
use App\Filament\Clusters\WGIndicators\Resources\GcrGovernanceWgiRqPhilippineRankingsResource\Pages;
use App\Filament\Clusters\WGIndicators\Resources\GcrGovernanceWgiRqPhilippineRankingsResource\RelationManagers;
...
class GcrGovernanceWgiRqPhilippineRankingsResource extends Resource
{
    protected static ?string $model = GcrGovernanceWgiRqPhilippineRankings::class;
    protected static ?string $modelLabel = 'WGI - Regulatory Quality Philippine Rankings';
    protected static ?string $navigationLabel = 'WGI-RQ Philippine Rankings';
    protected static ?string $navigationIcon = '/backend/assets/images/icon-rq.png';
    ...
    private static function validateUniqueYear(): callable
    {
        return function ($get, $record) {
            return function ($attribute, $value, $fail) use ($record) {
                $exists = GcrGovernanceWgiRqPhilippineRankings::where('year', $value)
    ...
    {
        return [
            'index' => Pages\ListGcrGovernanceWgiRqPhilippineRankings::route('/'),
        ];
    }
}
