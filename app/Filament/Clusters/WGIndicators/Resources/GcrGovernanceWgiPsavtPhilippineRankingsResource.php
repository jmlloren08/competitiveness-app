...
use App\Filament\Clusters\WGIndicators\Resources\GcrGovernanceWgiPsavtPhilippineRankingsResource\Pages;
use App\Filament\Clusters\WGIndicators\Resources\GcrGovernanceWgiPsavtPhilippineRankingsResource\RelationManagers;
...
class GcrGovernanceWgiPsavtPhilippineRankingsResource extends Resource
{
    protected static ?string $model = GcrGovernanceWgiPsavtPhilippineRankings::class;
    protected static ?string $modelLabel = 'WGI - Political Stability and Absence of Violence/Terrorism Philippine Rankings';
    protected static ?string $navigationLabel = 'WGI-PSAVT Philippine Rankings';
    protected static ?string $navigationIcon = '/backend/assets/images/icon-psavt.png';
    ...
    private static function validateUniqueYear(): callable
    {
        return function ($get, $record) {
            return function ($attribute, $value, $fail) use ($record) {
                $exists = GcrGovernanceWgiPsavtPhilippineRankings::where('year', $value)
    ...
    {
        return [
            'index' => Pages\ListGcrGovernanceWgiPsavtPhilippineRankings::route('/'),
        ];
    }
}
