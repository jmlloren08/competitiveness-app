...
use App\Filament\Clusters\WGIndicators\Resources\GcrGovernanceWgiCcPhilippineRankingsResource\Pages;
use App\Filament\Clusters\WGIndicators\Resources\GcrGovernanceWgiCcPhilippineRankingsResource\RelationManagers;
...
class GcrGovernanceWgiCcPhilippineRankingsResource extends Resource
{
    protected static ?string $model = GcrGovernanceWgiCcPhilippineRankings::class;
    protected static ?string $modelLabel = 'WGI - Control of Corruption Philippine Rankings';
    protected static ?string $navigationLabel = 'WGI-CC Philippine Rankings';
    protected static ?string $navigationIcon = '/backend/assets/images/icon-cc.png';
    ...
    private static function validateUniqueYear(): callable
    {
        return function ($get, $record) {
            return function ($attribute, $value, $fail) use ($record) {
                $exists = GcrGovernanceWgiCcPhilippineRankings::where('year', $value)
    ...
    {
        return [
            'index' => Pages\ListGcrGovernanceWgiCcPhilippineRankings::route('/'),
        ];
    }
}
