...
use App\Filament\Clusters\WGIndicators\Resources\GcrGovernanceWgiGePhilippineRankingsResource\Pages;
use App\Filament\Clusters\WGIndicators\Resources\GcrGovernanceWgiGePhilippineRankingsResource\RelationManagers;
...
class GcrGovernanceWgiGePhilippineRankingsResource extends Resource
{
    protected static ?string $model = GcrGovernanceWgiGePhilippineRankings::class;
    protected static ?string $modelLabel = 'WGI - Government Effectiveness Philippine Rankings';
    protected static ?string $navigationLabel = 'WGI-GE Philippine Rankings';
    protected static ?string $navigationIcon = '/backend/assets/images/icon-ge.png';
    ...
    private static function validateUniqueYear(): callable
    {
        return function ($get, $record) {
            return function ($attribute, $value, $fail) use ($record) {
                $exists = GcrGovernanceWgiGePhilippineRankings::where('year', $value)
    ...
    {
        return [
            'index' => Pages\ListGcrGovernanceWgiGePhilippineRankings::route('/'),
        ];
    }
}
