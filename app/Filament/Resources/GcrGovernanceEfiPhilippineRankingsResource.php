...
use App\Filament\Resources\GcrGovernanceEfiPhilippineRankingsResource\Pages;
use App\Filament\Resources\GcrGovernanceEfiPhilippineRankingsResource\RelationManagers;
...
class GcrGovernanceEfiPhilippineRankingsResource extends Resource
{
    protected static ?string $model = GcrGovernanceEfiPhilippineRankings::class;
    protected static ?string $modelLabel = 'Economic Freedom Index Philippine Rankings';
    protected static ?string $navigationLabel = 'EFI Philippine Rankings';
    protected static ?string $navigationGroup = 'Governance';
    protected static ?string $navigationIcon = '/backend/assets/images/icon-efi.png';
    ...
    private static function validateUniqueYear(): callable
    {
        return function ($get, $record) {
            return function ($attribute, $value, $fail) use ($record) {
                $exists = GcrGovernanceEfiPhilippineRankings::where('year', $value)
    ...
    {
        return [
            'index' => Pages\ListGcrGovernanceEfiPhilippineRankings::route('/'),
        ];
    }
}
