...
use App\Filament\Resources\GcrDigitalWdcrPhilippineRankingsResource\Pages;
use App\Filament\Resources\GcrDigitalWdcrPhilippineRankingsResource\RelationManagers;
...
class GcrDigitalWdcrPhilippineRankingsResource extends Resource
{
    protected static ?string $model = GcrDigitalWdcrPhilippineRankings::class;
    protected static ?string $modelLabel = 'World Digital Competitiveness Philippine Rankings';
    protected static ?string $navigationLabel = 'WDCR Philippine Rankings';
    protected static ?string $navigationGroup = 'Digital';
    protected static ?string $navigationIcon = '/backend/assets/images/icon-wdcr.png';
    ...
    private static function validateUniqueYear(): callable
    {
        return function ($get, $record) {
            return function ($attribute, $value, $fail) use ($record) {
                $exists = GcrDigitalWdcrPhilippineRankings::where('year', $value)
    ...
    {
        return [
            'index' => Pages\ListGcrDigitalWdcrPhilippineRankings::route('/'),
        ];
    }
}
