...
use App\Filament\Resources\GcrEeEtiIndicatorRankingsResource\Pages;
use App\Filament\Resources\GcrEeEtiIndicatorRankingsResource\RelationManagers;
...
class GcrEeEtiIndicatorRankingsResource extends Resource
{
    protected static ?string $model = GcrEeEtiIndicatorRankings::class;
    protected static ?string $modelLabel = 'Energy Transition Index Rankings per Indicator';
    protected static ?string $navigationLabel = 'ETI Rankings per Indicator';
    ...
    private static function validateUniqueReport(): callable
    {
        return function ($get, $record) {
            return function ($attribute, $value, $fail) use ($get, $record) {
                ...
                $exists = GcrEeEtiIndicatorRankings::where([
                    ['years', '=', $get('years')],
    ...
    {
        return [
            'Education & Human Capital' => 'Education & Human Capital',
            'Equitable' => 'Equitable',
            'Finance & Investment' => 'Finance & Investment',
            'Infrastructure' => 'Infrastructure',
            'Innovation' => 'Innovation',
            'Institutions & Governance' => 'Institutions & Governance',
            'Regulation & Political Commitment' => 'Regulation & Political Commitment',
            'Secure' => 'Secure',
    ...
    {
        return [
            'index' => Pages\ListGcrEeEtiIndicatorRankings::route('/'),
        ];
    }
}
