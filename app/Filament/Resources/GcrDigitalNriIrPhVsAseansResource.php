...
use App\Filament\Resources\GcrDigitalNriIrPhVsAseansResource\Pages;
use App\Filament\Resources\GcrDigitalNriIrPhVsAseansResource\RelationManagers;
...
class GcrDigitalNriIrPhVsAseansResource extends Resource
{
    protected static ?string $model = GcrDigitalNriIrPhVsAseans::class;
    protected static ?string $modelLabel = 'Network Readiness Index Rankings per Indicator';
    protected static ?string $navigationLabel = 'NRI Rankings per Indicator';
    protected static ?string $navigationGroup = 'Digital';
    protected static ?string $navigationParentItem = 'NRI Philippine Rankings';
    ...
    private static function validateUniqueReport(): callable
    {
        return function ($get, $record) {
            return function ($attribute, $value, $fail) use ($get, $record) {
                ...
                $exists = GcrDigitalNriIrPhVsAseans::where([
                    ['years', '=', $get('years')],
    ...
    private static function getIndicatorOptions(): array
    {
        return [
            ...
            'Impact' => 'Impact',
            'People' => 'People',
            'Sub-pillar 1.1 Access' => 'Sub-pillar 1.1 Access',
            'Sub-pillar 1.2 Content' => 'Sub-pillar 1.2 Content',
            'Sub-pillar 1.3 Future Technologies' => 'Sub-pillar 1.3 Future Technologies',
            'Sub-pillar 2.1 Individuals' => 'Sub-pillar 2.1 Individuals',
            'Sub-pillar 2.2 Businesses' => 'Sub-pillar 2.2 Businesses',
            'Sub-pillar 2.3 Governments' => 'Sub-pillar 2.3 Governments',
            'Sub-pillar 3.1 Trust' => 'Sub-pillar 3.1 Trust',
            'Sub-pillar 3.2 Regulation' => 'Sub-pillar 3.2 Regulation',
            'Sub-pillar 3.3 Inclusion' => 'Sub-pillar 3.3 Inclusion',
            'Sub-pillar 4.1 Economy' => 'Sub-pillar 4.1 Economy',
            'Sub-pillar 4.2 Quality of Life' => 'Sub-pillar 4.2 Quality of Life',
            'Sub-pillar 4.3 SDG Contribution' => 'Sub-pillar 4.3 SDG Contribution',
    ...
    {
        return [
            'index' => Pages\ListGcrDigitalNriIrPhVsAseans::route('/'),
        ];
    }
}
