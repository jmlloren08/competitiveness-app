...
use App\Filament\Resources\GcrEtiPisaPhilippineRankingsResource\Pages;
use App\Filament\Resources\GcrEtiPisaPhilippineRankingsResource\RelationManagers;
...
class GcrEtiPisaPhilippineRankingsResource extends Resource
{
    protected static ?string $model = GcrEtiPisaPhilippineRankings::class;
    protected static ?string $modelLabel = 'Programme for International Student Assessment Philippine Rankings';
    protected static ?string $navigationLabel = 'PISA Philippine Rankings';
    protected static ?string $navigationGroup = 'Education Talent & Innovation';
    protected static ?string $navigationIcon = '/backend/assets/images/icon-pisa.png';
    ...
    private static function validateUniqueYear(): callable
    {
        return function ($get, $record) {
            return function ($attribute, $value, $fail) use ($record) {
                $exists = GcrEtiPisaPhilippineRankings::where('year', $value)
    ...
    {
        return [
            'index' => Pages\ListGcrEtiPisaPhilippineRankings::route('/'),
        ];
    }
}
