...
use App\Filament\Resources\GcrEeEpiPhilippineRankingsResource\Pages;
use App\Filament\Resources\GcrEeEpiPhilippineRankingsResource\RelationManagers;
...
class GcrEeEpiPhilippineRankingsResource extends Resource
{
    protected static ?string $model = GcrEeEpiPhilippineRankings::class;
    protected static ?string $modelLabel = 'Environmental Performance Index Philippine Rankings';
    protected static ?string $navigationLabel = 'EPI Philippine Rankings';
    protected static ?string $navigationGroup = 'Energy and Environment';
    protected static ?string $navigationIcon = '/backend/assets/images/icon-epi.png';
    ...
    private static function validateUniqueYear(): callable
    {
        return function ($get, $record) {
            return function ($attribute, $value, $fail) use ($record) {
                $exists = GcrEeEpiPhilippineRankings::where('year', $value)
    ...
    {
        return [
            'index' => Pages\ListGcrEeEpiPhilippineRankings::route('/'),
        ];
    }
}
