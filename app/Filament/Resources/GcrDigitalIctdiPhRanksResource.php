...
use App\Filament\Resources\GcrDigitalIctdiPhRanksResource\Pages;
use App\Filament\Resources\GcrDigitalIctdiPhRanksResource\RelationManagers;
...
class GcrDigitalIctdiPhRanksResource extends Resource
{
    protected static ?string $model = GcrDigitalIctdiPhRanks::class;
    protected static ?string $modelLabel = 'ICT Development Index Philippine Rankings';
    protected static ?string $navigationLabel = 'ICTDI Philippine Rankings';
    protected static ?string $navigationGroup = 'Digital';
    protected static ?string $navigationIcon = '/backend/assets/images/icon-ictdi.png';
    ...
    private static function validateUniqueYear(): callable
    {
        return function ($get, $record) {
            return function ($attribute, $value, $fail) use ($record) {
                $exists = GcrDigitalIctdiPhRanks::where('year', $value)
    ...
    {
        return [
            'index' => Pages\ListGcrDigitalIctdiPhRanks::route('/'),
        ];
    }
}
