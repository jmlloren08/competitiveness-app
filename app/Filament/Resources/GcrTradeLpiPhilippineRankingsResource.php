...
use App\Filament\Resources\GcrTradeLpiPhilippineRankingsResource\Pages;
use App\Filament\Resources\GcrTradeLpiPhilippineRankingsResource\RelationManagers;
...
class GcrTradeLpiPhilippineRankingsResource extends Resource
{
    protected static ?string $model = GcrTradeLpiPhilippineRankings::class;
    protected static ?string $modelLabel = 'Logistics Performance Index Philippine Rankings';
    protected static ?string $navigationLabel = 'LPI Philippine Rankings';
    protected static ?string $navigationGroup = 'Trade';
    protected static ?string $navigationIcon = '/backend/assets/images/icon-lpi.png';
    ...
    private static function validateUniqueYear(): callable
    {
        return function ($get, $record) {
            return function ($attribute, $value, $fail) use ($record) {
                $exists = GcrTradeLpiPhilippineRankings::where('year', $value)
    ...
    {
        return [
            'index' => Pages\ListGcrTradeLpiPhilippineRankings::route('/'),
        ];
    }
}
