...
use App\Filament\Resources\GcrGeneralWcyPhRanksResource\Pages;
use App\Filament\Resources\GcrGeneralWcyPhRanksResource\RelationManagers;
...
class GcrGeneralWcyPhRanksResource extends Resource
{
    protected static ?string $model = GcrGeneralWcyPhRanks::class;
    protected static ?string $modelLabel = 'World Competitiveness Yearbook Philippine Rankings';
    protected static ?string $navigationLabel = 'WCY Philippine Rankings';
    protected static ?string $navigationGroup = 'General';
    protected static ?string $navigationIcon = '/backend/assets/images/icon-wcy.png';
    ...
    private static function validateUniqueYear(): callable
    {
        return function ($get, $record) {
            return function ($attribute, $value, $fail) use ($record) {
                $exists = GcrGeneralWcyPhRanks::where('year', $value)
    ...
    {
        return [
            'index' => Pages\ListGcrGeneralWcyPhRanks::route('/'),
        ];
    }
}
