...
use App\Filament\Resources\GcrEtiWtrPhilippineRankingsResource\Pages;
use App\Filament\Resources\GcrEtiWtrPhilippineRankingsResource\RelationManagers;
...
class GcrEtiWtrPhilippineRankingsResource extends Resource
{
    protected static ?string $model = GcrEtiWtrPhilippineRankings::class;
    protected static ?string $modelLabel = 'World Talent Ranking Philippine Rankings';
    protected static ?string $navigationLabel = 'WTR Philippine Rankings';
    protected static ?string $navigationGroup = 'Education Talent & Innovation';
    protected static ?string $navigationIcon = '/backend/assets/images/icon-wtr.png';
    ...
    private static function validateUniqueYear(): callable
    {
        return function ($get, $record) {
            return function ($attribute, $value, $fail) use ($record) {
                $exists = GcrEtiWtrPhilippineRankings::where('year', $value)
    ...
    {
        return [
            'index' => Pages\ListGcrEtiWtrPhilippineRankings::route('/'),
        ];
    }
}
