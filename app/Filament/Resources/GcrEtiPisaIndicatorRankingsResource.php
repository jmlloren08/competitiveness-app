...
use App\Filament\Resources\GcrEtiPisaIndicatorRankingsResource\Pages;
use App\Filament\Resources\GcrEtiPisaIndicatorRankingsResource\RelationManagers;
...
class GcrEtiPisaIndicatorRankingsResource extends Resource
{
    protected static ?string $model = GcrEtiPisaIndicatorRankings::class;
    protected static ?string $modelLabel = 'Programme for International Student Assessment Index Rankings per Indicator';
    protected static ?string $navigationLabel = 'PISA Rankings per Indicator';
    protected static ?string $navigationGroup = 'Education Talent & Innovation';
    protected static ?string $navigationParentItem = 'PISA Philippine Rankings';
    ...
    private static function validateUniqueReport(): callable
    {
        return function ($get, $record) {
            return function ($attribute, $value, $fail) use ($get, $record) {
                ...
                $exists = GcrEtiPisaIndicatorRankings::where([
                    ['years', '=', $get('years')],
    ...
    private static function getIndicatorOptions(): array
    {
        return [
            ...
            'Science literacy' => 'Science literacy',
        ];
    }
    ...
    {
        return [
            'index' => Pages\ListGcrEtiPisaIndicatorRankings::route('/'),
        ];
    }
}
