...
use App\Filament\Resources\GcrDigitalGtmiPhRanksResource\Pages;
use App\Filament\Resources\GcrDigitalGtmiPhRanksResource\RelationManagers;
...
class GcrDigitalGtmiPhRanksResource extends Resource
{
    protected static ?string $model = GcrDigitalGtmiPhRanks::class;
    protected static ?string $modelLabel = 'GovTech Maturity Index Philippine Rankings';
    protected static ?string $navigationLabel = 'GTMI Philippine Rankings';
    protected static ?string $navigationGroup = 'Digital';
    protected static ?string $navigationIcon = '/backend/assets/images/icon-gtmi.png';
    ...
    private static function validateUniqueYear(): callable
    {
        return function ($get, $record) {
            return function ($attribute, $value, $fail) use ($record) {
                $exists = GcrDigitalGtmiPhRanks::where('year', $value)
    ...
    {
        return [
            'index' => Pages\ListGcrDigitalGtmiPhRanks::route('/'),
        ];
    }
}
