...
use App\Filament\Resources\GcrDigitalNriPhRanksResource\Pages;
use App\Filament\Resources\GcrDigitalNriPhRanksResource\RelationManagers;
...
class GcrDigitalNriPhRanksResource extends Resource
{
    protected static ?string $model = GcrDigitalNriPhRanks::class;
    protected static ?string $modelLabel = 'Network Readiness Index Philippine Rankings';
    protected static ?string $navigationLabel = 'NRI Philippine Rankings';
    protected static ?string $navigationGroup = 'Digital';
    protected static ?string $navigationIcon = '/backend/assets/images/icon-nri.png';
    ...
    private static function validateUniqueYear(): callable
    {
        return function ($get, $record) {
            return function ($attribute, $value, $fail) use ($record) {
                $exists = GcrDigitalNriPhRanks::where('year', $value)
    ...
    {
        return [
            'index' => Pages\ListGcrDigitalNriPhRanks::route('/'),
        ];
    }
}
