...
use App\Filament\Resources\GcrHnGhsiPhilippineRankingsResource\Pages;
use App\Filament\Resources\GcrHnGhsiPhilippineRankingsResource\RelationManagers;
...
class GcrHnGhsiPhilippineRankingsResource extends Resource
{
    protected static ?string $model = GcrHnGhsiPhilippineRankings::class;
    protected static ?string $modelLabel = 'Global Health Security Index Philippine Rankings';
    protected static ?string $navigationLabel = 'GHSI Philippine Rankings';
    protected static ?string $navigationGroup = 'Health & Nutrition';
    protected static ?string $navigationIcon = '/backend/assets/images/icon-ghsi.png';
    ...
    private static function validateUniqueYear(): callable
    {
        return function ($get, $record) {
            return function ($attribute, $value, $fail) use ($record) {
                $exists = GcrHnGhsiPhilippineRankings::where('year', $value)
    ...
    {
        return [
            'index' => Pages\ListGcrHnGhsiPhilippineRankings::route('/'),
        ];
    }
}
