...
use App\Filament\Resources\GcrGovernanceBrDbrPhilippineRankingsResource\Pages;
use App\Filament\Resources\GcrGovernanceBrDbrPhilippineRankingsResource\RelationManagers;
...
class GcrGovernanceBrDbrPhilippineRankingsResource extends Resource
{
    protected static ?string $model = GcrGovernanceBrDbrPhilippineRankings::class;
    protected static ?string $modelLabel = 'B-Ready/Doing Business Report Philippine Rankings';
    protected static ?string $navigationLabel = 'BR/DBD Philippine Rankings';
    protected static ?string $navigationGroup = 'Governance';
    protected static ?string $navigationIcon = '/backend/assets/images/icon-brdbr.png';
    ...
    private static function validateUniqueYear(): callable
    {
        return function ($get, $record) {
            return function ($attribute, $value, $fail) use ($record) {
                $exists = GcrGovernanceBrDbrPhilippineRankings::where('year', $value)
    ...
    {
        return [
            'index' => Pages\ListGcrGovernanceBrDbrPhilippineRankings::route('/'),
        ];
    }
}
