...
use App\Filament\Resources\GcrGovernanceCpiPhilippineRankingsResource\Pages;
use App\Filament\Resources\GcrGovernanceCpiPhilippineRankingsResource\RelationManagers;
...
class GcrGovernanceCpiPhilippineRankingsResource extends Resource
{
    protected static ?string $model = GcrGovernanceCpiPhilippineRankings::class;
    protected static ?string $modelLabel = 'Corruption Perceptions Index Philippine Rankings';
    protected static ?string $navigationLabel = 'CPI Philippine Rankings';
    protected static ?string $navigationGroup = 'Governance';
    protected static ?string $navigationIcon = '/backend/assets/images/icon-cpi.png';
    ...
    private static function validateUniqueYear(): callable
    {
        return function ($get, $record) {
            return function ($attribute, $value, $fail) use ($record) {
                $exists = GcrGovernanceCpiPhilippineRankings::where('year', $value)
    ...
    {
        return [
            'index' => Pages\ListGcrGovernanceCpiPhilippineRankings::route('/'),
        ];
    }
}
