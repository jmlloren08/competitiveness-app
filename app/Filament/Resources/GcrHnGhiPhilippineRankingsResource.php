...
use App\Filament\Resources\GcrHnGhiPhilippineRankingsResource\Pages;
use App\Filament\Resources\GcrHnGhiPhilippineRankingsResource\RelationManagers;
...
class GcrHnGhiPhilippineRankingsResource extends Resource
{
    protected static ?string $model = GcrHnGhiPhilippineRankings::class;
    protected static ?string $modelLabel = 'Global Hunger Index Philippine Rankings';
    protected static ?string $navigationLabel = 'GHI Philippine Rankings';
    protected static ?string $navigationGroup = 'Health & Nutrition';
    protected static ?string $navigationIcon = '/backend/assets/images/icon-ghi.png';
    ...
    private static function validateUniqueYear(): callable
    {
        return function ($get, $record) {
            return function ($attribute, $value, $fail) use ($record) {
                $exists = GcrHnGhiPhilippineRankings::where('year', $value)
    ...
    {
        return [
            'index' => Pages\ListGcrHnGhiPhilippineRankings::route('/'),
        ];
    }
}
