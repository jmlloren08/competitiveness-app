...
use App\Filament\Resources\GcrEtiGtciPhilippineRankingsResource\Pages;
use App\Filament\Resources\GcrEtiGtciPhilippineRankingsResource\RelationManagers;
...
class GcrEtiGtciPhilippineRankingsResource extends Resource
{
    protected static ?string $model = GcrEtiGtciPhilippineRankings::class;
    protected static ?string $modelLabel = 'Global Talent Competitiveness Index Philippine Rankings';
    protected static ?string $navigationLabel = 'GTCI Philippine Rankings';
    protected static ?string $navigationGroup = 'Education Talent & Innovation';
    protected static ?string $navigationIcon = '/backend/assets/images/icon-gtci.png';
    ...
    private static function validateUniqueYear(): callable
    {
        return function ($get, $record) {
            return function ($attribute, $value, $fail) use ($record) {
                $exists = GcrEtiGtciPhilippineRankings::where('year', $value)
    ...
    {
        return [
            'index' => Pages\ListGcrEtiGtciPhilippineRankings::route('/'),
        ];
    }
}
