...
use App\Filament\Resources\GcrEeEtiPhilippineRankingsResource\Pages;
use App\Filament\Resources\GcrEeEtiPhilippineRankingsResource\RelationManagers;
...
class GcrEeEtiPhilippineRankingsResource extends Resource
{
    protected static ?string $model = GcrEeEtiPhilippineRankings::class;
    protected static ?string $modelLabel = 'Energy Transition Index Philippine Rankings';
    protected static ?string $navigationLabel = 'ETI Philippine Rankings';
    protected static ?string $navigationGroup = 'Energy and Environment';
    protected static ?string $navigationIcon = '/backend/assets/images/icon-eti2.png';
    ...
    private static function validateUniqueYear(): callable
    {
        return function ($get, $record) {
            return function ($attribute, $value, $fail) use ($record) {
                $exists = GcrEeEtiPhilippineRankings::where('year', $value)
    ...
    {
        return [
            'index' => Pages\ListGcrEeEtiPhilippineRankings::route('/'),
        ];
    }
}
