...
use App\Filament\Resources\GcrEtiGiiPhilippineRankingsResource\Pages;
use App\Filament\Resources\GcrEtiGiiPhilippineRankingsResource\RelationManagers;
...
class GcrEtiGiiPhilippineRankingsResource extends Resource
{
    protected static ?string $model = GcrEtiGiiPhilippineRankings::class;
    protected static ?string $modelLabel = 'Global Innovation Index Philippine Rankings';
    protected static ?string $navigationLabel = 'GII Philippine Rankings';
    protected static ?string $navigationGroup = 'Education Talent & Innovation';
    protected static ?string $navigationIcon = '/backend/assets/images/icon-gii.png';
    ...
    private static function validateUniqueYear(): callable
    {
        return function ($get, $record) {
            return function ($attribute, $value, $fail) use ($record) {
                $exists = GcrEtiGiiPhilippineRankings::where('year', $value)
    ...
    {
        return [
            'index' => Pages\ListGcrEtiGiiPhilippineRankings::route('/'),
        ];
    }
}
